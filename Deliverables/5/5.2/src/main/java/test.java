...
public class test
{
    ...
    public String play(String stone, List<String[][]> arr)
    {
...
//            System.out.println();
        ...
        String coordinates=findposition(stone,arr);
...
//
    ...
    public String findposition(String stone, List<String[][]> arr)
    {
        String[][] input=arr.get(0);
        List<String[][]> arr1=new ArrayList<>();
        for(int i=0;i<arr.size();i++)
        {
            String[][] str=new String[19][19];
            for(int j=0;j<19;j++)
            {
                for(int k=0;k<19;k++)
                {
                    str[j][k]=arr.get(i)[j][k];
                }
            }
            arr1.add(str);
        }
        String[][] input1=arr1.get(0);
...
//                        System.out.println();
        ...
        for(int j=0;j<input1[0].length;j++)
        {
          //  System.out.println("aaaa");
            ...
            {
                if(input1[i][j].equals(" "))
                {
                    boolean checkvalidity=PlaceStoneValidity(stone,i,j,arr1);
                    if(checkvalidity)
                    {
                        return (j+1)+"-"+(i+1);
                    }
